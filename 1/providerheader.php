...
/* nav tab act<ive link:focus:hover */
...
$account_fetch=mysqli_fetch_assoc($account_query);
      ...
      $_SESSION['pcategory']=$account_fetch['p_jobCat'];
       $_SESSION['pfirstname']=$account_fetch['p_first'];
        $_SESSION['plastname']=$account_fetch['p_last'];
...
<section id="content" class="container" style="margin-top: -7%;">
    <!-- Begin .page-heading -->
    <div class="page-heading"  >
        <div class="media clearfix">
          <div class="media-left pr30">
            <a href="#">
              <img src="Assets1/provider/<?php echo $account_fetch['p_pics'] ?>" style="object-fit: cover; border-radius: 10px; width: 160px; height: 150px; padding:2%; float: left;"  class="mw140 mr mb20" >
          ...
          <div class="media-body va-m" >
            <h2 class="media-heading" style="text-align: left; font-size: 40px; color: white !important;">
            	<?php echo $account_fetch['p_first']." ". $account_fetch['p_last']; ?>
              <small style="font-size: 15px; font-weight: bold; color: white !important;"> - Profile</small>
            </h2>
            <p class="lead" style="text-align: left; color: white !important; text-transform: uppercase;"><?php echo $account_fetch['p_profession']; ?></p>
