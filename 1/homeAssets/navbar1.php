				...
				<div class="container">
					...
					<nav class="wsmenu slideLeft clearfix">
						...
						<ul class="mobile-sub wsmenu-list pull-right">
							...
							<li><a href="clogin.php" class="">Find Work</a></li>
							<li><a href="login.php" class="">Post Jobs</a></li>
							<li><a href="covid.php" class="">Covid-19 Services</a>
							<!-- <li><a href="signup.php">About Us <span class="arrow"></span></a></li>
							 -->
							
							<li><a href="#" lass = "register" data-toggle = "modal" data-target = "#register"> <span class="arrow" ></span>Contact Us</a>
	   ...
	   <div class = "listing-modal-1 modal-dialog">
		  <div class = "modal-content">
			 <div class = "modal-header" style=" width: 100%; display: inline-block;">
				<button type = "button" class = "close" data-dismiss = "modal" aria-hidden = "true" style="margin-top:-5%;">&times;</button>
			 ...
			 <div class = "modal-body">
				<div class=" listing-register-form">
					<form method="POST">
                            ...
                            <div class="listing-form-field" >
                                <input class=" bgblue-1" name="submit" type="submit" value="Send Message" style="width:100%; margin-top: 3%; font-size: 18px; font-weight: bold; color: white;" />
                            </div>
                        </form>
