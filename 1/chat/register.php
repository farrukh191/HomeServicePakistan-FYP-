			...
			<div class="nav-wrapper"><!--main navigation-->
				<div class="container">
					...
					<nav class="wsmenu slideLeft clearfix">
						<div class="logo pull-left"><a href="../index.html" title="Responsive Slide Menus"><img src="../images/logo3.png" alt="" /></a></div>
						<ul class="mobile-sub wsmenu-list pull-right">
							<li><a href="../customerdashboard.php" class="">Dashboard</a>
							<li><a href="../jobposting.php" class="">Post Jobs</a>
								
							</li>
							<li><a href="../customerSeejobs.php" class="">Your Jobs proposal</a>
...
<div class = "modal fade bs-example-modal-sm " id = "logoutpop" tabindex = "-1" role = "dialog" aria-labelledby = "myModalLabel"  aria-hidden = "true">
	   <div class = "listing-modal-1 modal-dialog modal-content">
		  <div class="modal-content" style=" height: 200px;" >
		 	...
		 	<div class="modal-footer" style="position: absolute; left: 115px; top: 105px;">
		 		<div class="modal-footer"><a href="../customerlogout.php" class="btn btn-primary" style=" border-color: #08c2f3; background-color:#08c2f3;">Logout</a>
