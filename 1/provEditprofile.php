...
if (isset($_POST['chgpass'])) {
	if ($pas == $_POST['opassword']) {
		if ($_POST['npassword'] == $_POST['cpassword'] and $_POST['npassword'] !=="" and $_POST['cpassword'] !=="") {
			$npas=$_POST['cpassword'];
			 $update = "UPDATE `provider_signup` SET p_pass='$npas',p_cpass='$npas' WHERE provider_id='$providerId'";
...
$upsele="SELECT * FROM provider_signup  WHERE provider_id='$providerId'";
...
if (isset($_POST['updatesubmit'])) {
	...
	$upexperience=$_POST['experience'];
	$upaddress=$_POST['address'];
	$updesc=$_POST['description'];
	$upprofess=$_POST['Professional'];
	$upcity=$_POST['City'];
	$uplang=$_POST['Language'];
	$upid=$_POST['IdNumber'];
	

	 $update="UPDATE provider_signup SET p_first='$upfirst', p_last='$uplast', p_exp='$upexperience', p_address='$upaddress', p_description='$updesc', p_profession='$upprofess', p_city='$upcity', p_language='$uplang', p_nic='$upid'  WHERE provider_id='$providerId'";
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="">
        ...
        <a class="btn btn-success btn-block"  href="providerLogout.php" style="text-decoration: none; color: white;">Go Login page</a>
      </div>
    </div>
  </div>
</div>    
...
$uploadfile=$_FILES["file"]["name"];
    ...
    $insert="UPDATE provider_signup SET p_pics='$uploadfile' WHERE provider_id='$providerId'";
...
<div class="static-header-content">
          ...
          <img src="Assets1/provider/<?php echo $upfet['p_pics']; ?>" id="profile-img-tag" style="width: 200px; height: 200px; margin:-140px auto; border-radius: 100px; border:2px solid white; object-fit: cover; ">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <div class="form-input">
                                    ...
                                    <input type="text" value='<?php echo $upfet['p_first']; ?>' name="first_name" id="first_name"  />
                                </div>
                                <div class="form-input">
                                    <label for="last_name"  class="required">Last name</label>
                                    <input type="text" value='<?php echo $upfet['p_last']; ?>' name="last_name" id="last_name"  />
                                </div>
                  <div class="form-select" style="margin-top: -0.6%;">
                
                <label for="meal_preference" style=" ">Experience</label>
                              <select style="height: 50px; border-color: #ebebeb !important;" class="form-select select-list" name="experience" aria-label=".form-select-lg example">
                        ...
                        <option value="Above 30 yrs">Above 30 yrs</option>
                                ...
                                <div class="form-input" style="margin-top: -15%;">
                                    <label for="Professional" class="required">Address</label>
                                    <!-- <input type="text" name="Professional" id="company"  /> -->
                                    <input type="text" name="address" value='<?php echo $upfet['p_address']; ?>'  style="width: 100%; height:70px; border-color: #ebebeb; border-radius: 5px; "  />
                                ...
                                <div class="form-input">
                                    ...
                                    <!-- <input type="text" name="Professional" id="company"  /> -->
                                    <input type="text" name="description" value='<?php echo $upfet['p_description']; ?>' style="width: 100%;  word-break: break-all; height:200px; border-color: #ebebeb; border-radius: 5px; "  />
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" value='<?php echo $upfet['p_profession']; ?>' name="Professional" id="blank_name"  />
                                </div>

                                <div class="form-input">
                                    <label for="blank_name">Language</label>
                                    <input type="text" value='<?php echo $upfet['p_language']; ?>' name="Language" id="skill" />
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" value='<?php echo $upfet['p_city']; ?>' name="City" id="blank_name"  />
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" value='<?php echo $upfet['p_nic']; ?>' name="IdNumber" id="Id Number"   />
                                </div>
