...
if (isset($_POST['login'])) {
    ...
    $match="select * from provider_signup where p_ph='$email' and p_pass='$password' ";
...
$message="";
	if ($ban == 'Active' OR $ban == '' ) {
	   $_SESSION['phone']=$fetc['p_ph'];
	   $_SESSION['first']=$fetc['p_first'];
	   $_SESSION['last']=$fetc['p_last'];
	   $_SESSION['password']=$fetc['p_pass'];
	   $_SESSION['providerId']=$fetc['provider_id'];
	 	?>
		...
		$message = "<div class='alert alert-danger'>your account has been suspended please contact at admin@homeservicepakistan.com</div>";
        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-img">
                    <img src="images/1.jpg" alt="" style="height: 600px;">
...
<span class="text-danger"><?php echo $message; ?></span>
					...
					<div class="tabcontent" id="sign-up">
						...
						<h3 style="text-align: center; color: #204d74">Provider Login Form</h3>
                        ...
                        <div style="width: 400px; margin:10% auto;">
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" name="emailAdd" id="phone_number" maxlength="11" pattern="[0-9]{11}" />
...
function myFunction() {
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
					...
					<p style="display: flex; flex-direction: row; padding-left: 25%;">if your are not member this website please <a href="clientlogin.php" style="padding: 0px 3px 0px 3px; color: dodgerblue; font-weight: bold;"> register </a> yourself.</p>
				</div>
				</form>
                </div>
            </div>
