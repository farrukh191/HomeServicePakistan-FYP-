 ...
 -->
                    ...
                    <form class="form-detail" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tabcontent" id="sign-up">
                            <h4 style="text-align: left;  color: #204d74; border-bottom: 1px solid #e0e0e0; padding: 1%;">You can directly contact with phone number</span></h4>
                                    ...
                                    <div class="sidebar-search-wrap">
                                        ...
                                        <form action="#" style="display: inline-block !important;">
                                         ...
                                         <div class="col-lg-4 col-md-4 col-sm-12 p-0">
                                            <select  id="keywordcity" class="form-control search-slt"onchange="searchFilter()" name="search" style="border-color: #ebebeb;" >
 ...
 -->
                            ...
                            <div class="post-wrapper">
                                ...
                                <div id="posts_content">
                                    ...
                                    //get number of rows
                                    $queryNum = mysqli_query($db, "SELECT COUNT(*) as covid_id FROM covid19");
                                    ...
                                    //get rows
                                    $query = mysqli_query($db, "SELECT * FROM `covid19` ORDER BY covid_id DESC LIMIT $limit ");
...
<div class="topnav">
  ...
  <a href="#news" style="font-weight: bold; width: 826px;height: 56px; text-align: left;"><?php echo $row['job']; ?></a><br>
  <p style=" text-align: left; font-weight: bold; color:black;"><?php echo $row['firstname'].' '.$row['lastname']; ?></p>
  ...
  <a href="#news" style=" width: 600px; font-size: 14px; text-align: left;"><i class="fa fa-map-marker" style="padding-right:1%; color: #08c2f3;"> </i><?php echo $row['address']." ".$row['city']; ?></a>
