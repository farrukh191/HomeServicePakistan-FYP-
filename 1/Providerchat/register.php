...
if (isset($_POST['submit'])) {
    ...
    $contactquery="insert into contact(name,phone,message,type,provider_id)values('$name','$number','$messagee','$type','$providerId')";
...
<body>
	...
	<div class="theme-wrap clearfix">
		...
		<div class="wsmenuexpandermain slideRight">
			...
			<a href="#" class="smallogo"><img src="../images/logoback1.png" width="120" alt="" /></a>
		</div>
		<!--================================HEADER==========================================-->
		<div class="header">
			...
			<div class="nav-wrapper" ><!--main navigation-->
				<div class="container">
					...
					<nav class="wsmenu slideLeft clearfix">
						<div class="logo pull-left"><a href="../index.html" title="Responsive Slide Menus"><img src="../images/logo4.png" alt="" /></a></div>
						<ul class="mobile-sub wsmenu-list pull-right">
							<li><a href="../providerProfile.php" class="">Dashboard</a>
							<li><a href="../jobshow.php" class="">Find Jobs</a>
								
							</li>
							<li><a href="../jobConfirmationMsg.php" class="">My Proposal</a>
								
							</li>
							<li><a href="../Providerchat/chatbox1.php">Message <span class="arrow"></span></a></li>
							
							<li><a href="" data-toggle="modal" data-target="#register">Contact Us <span class="arrow"></span></a></li>
							<li><a href="#"> <span class="arrow" ></span>profile</a>
								<ul class="wsmenu-submenu" >
									<li><a href="../provEditprofile.php">Edit Profile <span class="arrow"></span></a></li>
...
<div class = "modal fade bs-example-modal-sm" id = "logoutpop" tabindex = "-1" role = "dialog" aria-labelledby = "myModalLabel"  aria-hidden = "true">
      ...
      <div class="modal-footer"><a href="../providerLogout.php" class="btn btn-primary" style="margin-left: -7%; border-color: #08c2f3; background-color:#08c2f3;">Logout</a>
...
<div style="width: 100%; height: 120px;" >
		 	<div style="width: 100%;  float: left;  ">
		 		<h4 class = "modal-title" id = "myModalLabel" style="float: left; color: #08c2f3;"> LOGOUT <i class="fa fa-lock"></i></h4>
		 		<button type = "button" class = "close" data-dismiss = "modal" aria-hidden = "true" style="color: #08c2f3; font-weight: bold; float: right;">&times;</button>
		 	</div>
		 	<div style="float: left; border-bottom: 1px solid #e5e5e5; width: 100%; height: 49px;">
		 		 <div class="modal-body" style="font-size: 15px;  padding:20px 0px 10px 0px;"><i class="fa fa-question-circle"></i> Are you sure you want to log-off?</div>
		 	</div>
			 ...
			 <div class = "modal-body">
				<div class=" listing-register-form">
					 <form method="POST">
                            ...
                            <div class="listing-form-field">
                                <input class="form-field submit bgblue-1" name="submit" type="submit" value="Send Message" />
                            </div>
                        </form>
